...
public class AudioCalculator {
    ...
    private static String TAG = AudioCalculator.class.getSimpleName();
    ...
    public double getFrequency() {
        if (frequency == 0.0D) {
            ...
            DLog.d(TAG, "Frequency: "+frequency+"  bytes  "+bytes);
    ...
    private double retrieveFrequency() {
        ...
        DLog.d(TAG, "retrieveFrequency Frequency: "+frequency+"  bytes  "+bytes);
