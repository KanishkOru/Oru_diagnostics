...
import org.pervacio.onediaglib.advancedtest.common.RealDoubleFFT;
...
public class FrequencyCalculator {
    ...
    private static String TAG = FrequencyCalculator.class.getSimpleName();
    ...
    public void feedData(byte[] ds, int dsLen) {
        ...
        DLog.d(TAG, "feedData byte: "+ds+"  bytes  "+bytes);
    ...
    public double getFreq() {
        ...
        DLog.d(TAG, "maxAmpFreq byte: "+maxAmpFreq);
